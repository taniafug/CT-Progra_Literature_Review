...
def main():
    ...
    with st.sidebar:
        ...
        results_output_name = st.text_input("Results workbook filename", value="stage_5_results.xlsx")
        validation_output_name = st.text_input("Validation workbook filename", value="stage_5_author_validation.xlsx")
        costs_output_name = st.text_input("Costs workbook filename", value="stage_5_llm_costs.xlsx")
        analysis_input_output_name = st.text_input("Analysis input filename", value="stage_5_to_stage_6_input.xlsx")
